...
<div class="border-none pg1 section" id="home">
	...
	<div
		class=" relative lg:bg-[whitesmoke] lg:dark:bg-muted bg-muted md:pl-8 2xl:pl-[7rem] border-black 2xl:border-b-[0.15rem] 2xl:border-r-[0.1rem] 2xl:border-t-none rounded-md md:rounded-none"
	>
		<div
			class="h-[3rem] max-w-[30rem] 3xl:max-w-[45rem] text-center rounded-md hidden 2xl:flex bg-custom-background px-[5rem] 3xl:px-[14rem] border-[0.15rem] border-black mx-auto absolute bottom-[-1.5rem]"
		>
			<div class=" mt-1 text-3xl font-light text-foreground text-center">Professional Work</div>
		</div>
		<div class="main-text pt-[1.5rem] md:py-6 pb-4 2xl:pt-[4rem] 3xl:pt-[4rem] dark:text-[#f2f2f2]">
			{#if show}
				<h1
					transition:fly={{ x: -200, duration: 800 }}
					class="text-[4.5rem] hidden2 xl:text-[5rem] 3xl:text-[6.5rem]"
				>
					Full Stack
				</h1>
				...
				<div class="flex 2xl:hidden mt-4 gap-4">
					...
					<a href="https://www.linkedin.com/in/prahlad-sharma/" target="_blank">
						<img
							alt="linkedin logo"
							id="linkdin"
					...
					<a href="https://www.instagram.com/prahladhacker/" target="_blank">
						<img
							id="insta"
							alt="instagram logo"
			...
			{/if}
			<div
				class="hidden fixed bg-custom-background text-foreground left-0 z-50 flex-col gap-8 py-4 px-5 rounded-r-md border-black 2xl:flex hidden1 bg-[whitesmoke] top-[10rem] border-t-[0.15rem] border-b-[0.15rem] border-r-[0.15rem] 3xl:top-[12.75rem]"
			>
				<a href="https://github.com/Prahlad-Sharma" target="_blank">
					<img
						id="github"
